...
\begin{itemize}
    ...
    \item \textbf{Players Service} manages \textit{Players Database}. Since this service handles authentication and friendship logic, it must own the persistent user profiles and relationship metadata to enforce security and access control centrally.
