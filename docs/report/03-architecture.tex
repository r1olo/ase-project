...
Splitting data and functionalities among microservices.

\subsection{Inter-Service Communication}
The key service-to-service dependencies are justified as follows.\begin{itemize}
    \item \textbf{API Gateway} to all of the microservices
    \item \textbf{Matchmaking} to \textbf{Players}
    \item \textbf{Matchmaking} to \textbf{Game Engine}
    \item \textbf{Game Engine} to \textbf{Players}
    \item \textbf{Game Engine} to \textbf{Card Catalogue}
\end{itemize}
