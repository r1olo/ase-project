...
In order to test Game Engine Service, we mock the communication with the Card Catalogue Service and avoid the communication with Players Service, so that it is possible to verify the correct behavior of the game logic without relying on the actual services.
