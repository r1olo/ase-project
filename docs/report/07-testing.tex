...
\begin{enumerate}
    ...
    \item \textbf{integration-tests}: Builds the entire application image, and runs system-wide tests.
    \item \textbf{static-analysis \& build-and-scan}: Executes security audits and vulnerability scans.
    \item \textbf{pip-audit}: Performs security audits on Python dependencies.
\end{enumerate}
